...
<div class="content-wrapper">
    <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
            <h3 class="content-header-title mb-0 d-inline-block">Employee Aguinaldo Report</h3>
            <div class="row breadcrumbs-top d-inline-block">
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="<?php echo $result["Web_Url"]; ?>dashboard">Home</a>
                        </li>
                        <li class="breadcrumb-item active">Employee Aguinaldo Report
                        </li>
                    </ol>
                </div>
            </div>
    ...
    <div class="content-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="select2 form-control" id="employee_id_aguinaldo" name="employee_id_aguinaldo">
        ...
        <!-- File export table -->
        <div id="employee_aguinaldo_report"></div>
