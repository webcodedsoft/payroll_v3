...
<div class="content-wrapper">
    ...
    <div class="content-body">
        ...
        <div class="content-header row">
            ...
            <div class="content-header-right col-md-6 col-12">
                <div class="dropdown float-md-right">
                    <a href="<?php echo $result["Web_Url"]; ?>create-invoice"><button type="button" class="btn btn-info round btn-min-width mr-1 mb-1"> <i class="la la-plus"></i> Create Invoice</button></a>
                </div>
            </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-content collapse show ">
                            <div class="card-bodys card-dashboards table-responsive">
                                ...
                                <table class="table table-striped table-bordered" id="invoice_list">
                                    <thead>
                                        <tr>
                                            <th>Invoice ID</th>
                                            <th>Client</th>
