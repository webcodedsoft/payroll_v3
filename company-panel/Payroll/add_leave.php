...
<div class="content-wrapper">
    <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
            <h3 class="content-header-title mb-0 d-inline-block">Add Employee Leave </h3>
    ...
    <div class="content-body">
        ...
        <div class="content-header row">
            ...
            <div class="content-header-right col-md-6 col-12">
                <div class="dropdown float-md-right">
                    <button type="button" class="btn btn-info round btn-min-width mr-1 mb-1" data-toggle="modal" data-target="#add_employee_leave"> <i class="la la-plus"></i> Add Leave</button>
                </div>
            </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-content collapse show ">
                            <div class="card-bodys card-dashboards table-responsive">
                                ...
                                <table class="table table-striped table-bordered" id="employee_leave_list">
                                    <thead>
                                        <tr>
                                            <th><span data-i18n="fullname"> Fullname</span></th>
                                            <th><span data-i18n="tax_amount"> Working Days </span></th>
                                            <th><span data-i18n="tax_amount"> Day Used </span></th>
                                            <th><span data-i18n="tax_amount"> Enjoyment Date </span></th>
