...
<div class="content-wrapper">
    <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
            <h3 class="content-header-title mb-0 d-inline-block">Update Employee Earning</h3>
                        ...
                        <div class="card-content collapse show ">
                            ...
                            <div class="row" style="padding-left: 20px">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="select2 form-control" id="update_earning_payment_type" name="earning_payment_type">
                                ...
                                <div class="col-md-4">
                                    <fieldset class="form-group">
                                        ...
                                        <select class="select2 form-control earning_update_date" id="earning_update_date">
                                ...
                                <div class="col-md-2" style="padding-top: 18px">
                                    <button type="button" id="earning_update_search_btn" class="btn waves-effect waves-light btn-block btn-info" data-i18n="submit_btn">
                            ...
                            <div class="card-body card-dashboard table-responsive">
                                <table class="table table-striped table-bordered" id="employee_earning_list">
                                    ...
                                    <tbody id="employee_earning_update_table">
                                        <td colspan="10">
                            ...
                            <div class="row col-md-12" style="padding-bottom:20px" id="update_computation_div">
                                <div class="col-md-4">
                                    <label>Foreign Currency Exchange Rate:</label>
                                    <input type="text" class="form-control" id="update_exchange_rate" required placeholder="0" name="update_exchange_rate" />
                                </div>
                                <div class="col-md-4" style="padding-top: 18px">
                                    <button type="submit" id="update_earning_btn" name="update_earning_btn" class="btn waves-effect waves-light btn-block btn-info" data-i18n="submit_btn">
