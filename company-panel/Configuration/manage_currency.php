...
<div class="content-wrapper">
    <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
            <h3 class="content-header-title mb-0 d-inline-block">Currency Settings </h3>
            <div class="row breadcrumbs-top d-inline-block">
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="<?php echo $result["Web_Url"]; ?>dashboard">Home</a>
                        </li>
                        <li class="breadcrumb-item active">Currency Settings
                        </li>
                    </ol>
                </div>
            </div>
    ...
    <div class="content-body">
        ...
        <div class="content-header row">
            ...
            <div class="content-header-right col-md-6 col-12">
                <div class="dropdown float-md-right">
                    <button type="button" class="btn btn-info round btn-min-width mr-1 mb-1" data-toggle="modal" data-target="#add_currency"> <i class="la la-plus"></i> Add Currency</button>
                </div>
            </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-content collapse show ">
                            <div class="card-bodys card-dashboards table-responsive">
                                ...
                                <table class="table table-striped table-bordered" id="currency_list">
                                    <thead>
                                        <tr>
                                            <th><span data-i18n="country_name"> Country Name </span></th>
                                            <th><span data-i18n="currency_name"> Currency Name </span></th>
                                            <th><span data-i18n="currency_code"> Currency Code </span></th>
                                            <th><span data-i18n="currency_symbol"> Currency Symbol </span></th>
                                            <th><span data-i18n="currency_type"> Currency Type </span></th>
