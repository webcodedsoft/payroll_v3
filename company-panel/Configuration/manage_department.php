...
<div class="content-wrapper">
    ...
    <div class="content-body">
        ...
        <div class="content-header row">
            ...
            <div class="content-header-right col-md-6 col-12">
                <div class="dropdown float-md-right">
                    <button type="button" class="btn btn-info round btn-min-width mr-1 mb-1" data-toggle="modal" data-target="#add_department"> <i class="la la-plus"></i> Add Department </button>
                </div>
            </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-content collapse show ">
                            <div class="card-bodys card-dashboards table-responsive">
                                ...
                                <table class="table table-striped table-bordered" id="department_list">
                                    <thead>
                                        <tr>
                                            <th><span data-i18n="department_name"> Department Name </span></th>
                                            <th><span data-i18n="department_desc"> Department Description </span></th>
