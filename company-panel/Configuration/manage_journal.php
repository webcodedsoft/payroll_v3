...
<div class="content-wrapper">
            ...
            <div class="row breadcrumbs-top d-inline-block">
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Journal List
                        </li>
                    </ol>
                </div>
            </div>
    ...
    <div class="content-body">
        ...
        <div class="content-header row">
            ...
            <div class="content-header-right col-md-6 col-12">
                <div class="dropdown float-md-right">
                    <button type="button" class="btn btn-info round btn-min-width mr-1 mb-1" data-toggle="modal" data-target="#edit_journal"> <i class="la la-plus"></i> Edit Journal </button>
                </div>
            </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-content collapse show ">
                            <div class="card-bodys card-dashboards table-responsive">
                                ...
                                <table class="table table-striped table-bordered" id="journal_list">
                                    <thead>
                                        <tr>
                                            <th>S/N</th>
                                            <th><span data-i18n="accounting_name"> Accounting Name </span></th>
                                            <th><span data-i18n="accounting_code"> Accounting Code </span></th>
