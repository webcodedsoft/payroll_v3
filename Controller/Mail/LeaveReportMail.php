...
class Controller_Mail_LeaveReportMail
{
    ...
    public function LeaveReportMail($earning_id){
        ...
        $payment_proof_html_file = $this->mail_file->LeaveReportHTML($earning_id);
        ...
        $url_path = Classes_Session::get("Loggedin_Session") . "/Leave_Report/";

        if (Classes_Folder::create($url_path)) {
            $url_path = "../../Folders/Company_Folders/" . Classes_Session::get("Loggedin_Session") . "/Leave_Report/" . $first_name . '_' . date("Y_m_d") . ".pdf";
        } else {
            $url_path = "../../Folders/Company_Folders/" . Classes_Session::get("Loggedin_Session") . "/Leave_Report/" . $first_name . '_' . date("Y_m_d") . ".pdf";
        }
    ...
    public function LeaveReportDownload($earning_id)
    {
        ...
        $_html_file = $this->mail_file->LeaveReportHTML($earning_id);
